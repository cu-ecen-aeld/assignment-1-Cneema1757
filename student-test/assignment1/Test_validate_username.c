...
void test_validate_my_username()
{
     ...
     */
    const char* username_ = my_username();
    const char* username_mall = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_,username_mall,"Matched");
}
